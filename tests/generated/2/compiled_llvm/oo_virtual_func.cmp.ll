; ModuleID = 'generated/2/binary/oo_virtual_func.o.0.5.precodegen.bc'
...
define dso_local i32 @main() local_unnamed_addr #2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  store volatile i32 3, i32* %4, align 8, !tbaa !6
  store volatile i32 4, i32* %4, align 8, !tbaa !6
  %5 = load volatile i32, i32* %4, align 8, !tbaa !6
  %6 = icmp eq i32 %5, 4
