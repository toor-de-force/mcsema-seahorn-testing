; ModuleID = 'generated/2/binary/multi_call_inter_seq.o.0.5.precodegen.bc'
...
; Function Attrs: noinline norecurse nounwind uwtable
define internal fastcc i32 @_Z5func1i(i32 returned %0) unnamed_addr #0 {
...
4:                                                ; preds = %0
  %5 = add nsw i32 %1, 2
  %6 = tail call fastcc i32 @_Z5func1i(i32 %5) #3
  %7 = add nsw i32 %1, 4
  %8 = tail call fastcc i32 @_Z5func1i(i32 %7) #3
  br label %9
