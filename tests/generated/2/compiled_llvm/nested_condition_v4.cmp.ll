; ModuleID = 'generated/2/binary/nested_condition_v4.o.0.5.precodegen.bc'
...
define dso_local i32 @main() local_unnamed_addr #2 {
  ...
  %.0.sroa_cast8 = bitcast i32* %1 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %.0.sroa_cast8)
...
6:                                                ; preds = %0
  ...
  %8 = add nsw i32 %.0.6, 1
  %.0.2 = load volatile i32, i32* %2, align 4
  %9 = icmp eq i32 %8, %.0.2
...
11:                                               ; preds = %10, %6
  ...
  %.0.3 = load volatile i32, i32* %2, align 4
  %12 = add nsw i32 %.0.3, 2
  %13 = icmp eq i32 %.0.7, %12
...
15:                                               ; preds = %14, %11, %0
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %.0.sroa_cast8)
  ret i32 0
}
