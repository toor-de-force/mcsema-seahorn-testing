; ModuleID = 'generated/1/binary/inter_rv.o.0.5.precodegen.bc'
...
define internal i32 @_Z5func1v() #3 {
  %1 = tail call i32 @rand() #5
  %2 = and i32 %1, 65535
  %3 = tail call i32 @_Z7far_addi(i32 %2)
  ret i32 %3
}
...
define dso_local i32 @main() #3 {
  ...
  %2 = tail call i32 @_Z5func1v()
  %3 = tail call i32 @_Z5func1v()
  %4 = add nsw i32 %3, %2
  %5 = icmp eq i32 %4, 5
