; ModuleID = 'generated/1/binary/up_and_down_v1.o.0.5.precodegen.bc'
...
define internal i32 @_Z5func2i(i32 %0) #2 {
  ...
  %4 = tail call i32 @_Z5func1i(i32 %3)
  ret i32 %4
}

; Function Attrs: norecurse nounwind readnone uwtable
define internal i32 @_Z5func3i(i32 %0) #2 {
  %2 = icmp eq i32 %0, 6
  %3 = select i1 %2, i32 7, i32 9
  %4 = tail call i32 @_Z5func2i(i32 %3)
  ret i32 %4
}

; Function Attrs: norecurse nounwind readnone uwtable
define internal i32 @_Z5func4i(i32 %0) #2 {
  %2 = icmp eq i32 %0, 2
...
; Function Attrs: norecurse nounwind readnone uwtable
define internal i32 @_Z5func5i(i32 %0) #2 {
  %2 = icmp eq i32 %0, 11
  %3 = select i1 %2, i32 2, i32 5
  %4 = tail call i32 @_Z5func4i(i32 %3)
  ret i32 %4
}
...
define dso_local i32 @main() #3 {
  ...
  %3 = tail call i32 @_Z5func3i(i32 %2)
  %4 = tail call i32 @_Z5func5i(i32 %3)
  %5 = icmp eq i32 %4, 8
