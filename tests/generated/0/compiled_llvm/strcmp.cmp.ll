; ModuleID = 'generated/0/binary/strcmp.o.0.5.precodegen.bc'
...
define dso_local i32 @main() #3 {
  ...
  %4 = call i32 @strcmp(i8* %3, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i32 0, i32 0)) #4
  %5 = icmp eq i32 %4, 0
...
7:                                                ; preds = %6, %0
  %8 = getelementptr inbounds [20 x i8], [20 x i8]* %2, i64 0, i64 4
  store i8 0, i8* %8, align 4
  %9 = getelementptr inbounds [20 x i8], [20 x i8]* %2, i32 0, i32 0
  %10 = call i32 @strcmp(i8* %9, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i32 0, i32 0)) #4
  %11 = icmp eq i32 %10, 0
