; ModuleID = 'generated/0/binary/recurse_v2.o.0.5.precodegen.bc'
...
define internal void @_Z10path_startv() #0 {
  %1 = call i64 @time(i64* @global_time) #5
  ret void
}
...
define internal void @_Z21example_constrain_argii(i32 %0, i32 %1) #0 {
  ...
  %5 = call i64 @time(i64* @global_time) #5
  ret void
}
...
define internal i32 @_Z21example_constrain_reti(i32 %0) #0 {
  ...
  %3 = alloca i32, align 4
  store i32 %0, i32* %3, align 4
  %4 = call i64 @time(i64* @global_time) #5
  call void @llvm.trap()
  unreachable
...
define internal i32 @_Z15example_counterv() #0 {
  ...
  %2 = call i64 @time(i64* @global_time) #5
  call void @llvm.trap()
  unreachable
...
define internal i32 @_Z4funci(i32 %0) #3 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  store i32 %0, i32* %3, align 4
...
attributes #4 = { noinline norecurse optnone uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="all" "less-precise-fpmad"="false" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
