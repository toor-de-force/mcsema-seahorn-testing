; ModuleID = 'generated/0/binary/func_array.o.0.5.precodegen.bc'
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @_Z5func1v() #0 {
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @_Z5func3v() #0 {
  store volatile i32 5, i32* @x, align 4
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define internal void @_Z5func4v() #0 {
  store volatile i32 6, i32* @x, align 4
  ret void
}
...
define dso_local i32 @main() #3 {
  %1 = alloca i32, align 4
  %2 = alloca [4 x void ()*], align 16
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  store i32 0, i32* %1, align 4
  %5 = bitcast [4 x void ()*]* %2 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %5, i8* align 16 bitcast ([4 x void ()*]* @_ZZ4mainE5funcs to i8*), i64 32, i1 false)
...
12:                                               ; preds = %8
  ...
  %15 = getelementptr inbounds [4 x void ()*], [4 x void ()*]* %2, i64 0, i64 %14
...
20:                                               ; preds = %8
  %21 = load volatile i32, i32* @x, align 4
  %22 = icmp eq i32 %21, 5
